        ...
        <CardContent>
          <Grid item xs={12} className={classes.column}>
            <div className={classes.row}>
              ...
              <div className={classes.inputContainer}>
                <Typography variant="body2">
                  Fees Category <span className={classes.required}>*</span>
                </Typography>
                <FormControl variant="filled" className={classes.textField}>
                  <Select
                    value={userType}
              ...
              <div className={classes.inputContainer}>
                <Typography variant="body2">
                  Fees Sub Category <span className={classes.required}>*</span>
                </Typography>
                <FormControl variant="filled" className={classes.textField}>
                  <Select
                    value={userType}
            ...
            <div className={classes.row}>
              <div className={classes.inputContainer}>
                <Typography variant="body2">
                  Fees Type <span className={classes.required}>*</span>
                </Typography>
                <FormControl variant="filled" className={classes.textField}>
                  <Select
                    value={userType}
