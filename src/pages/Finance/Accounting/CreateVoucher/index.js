        ...
        <Grid item xs={12} md={6}>
          <Card elevation={3} className={classes.card}>
            ...
            <CardContent>
              ...
              <div className={classes.inputContainer}>
                <Typography variant="body2">
                  Voucher Master <span className={classes.required}>*</span>
                </Typography>
              ...
              <div className={classes.inputContainer}>
                <Typography variant="body2">Voucher Head</Typography>
                <FormControl variant="filled" className={classes.textField}>
                  <Select
                    value={userType}
                    variant="outlined"
              ...
              <div className={classes.inputContainer}>
                <Typography variant="body2">From Ledger Account</Typography>
                <FormControl variant="filled" className={classes.textField}>
                  <Select
                    value={userType}
                    variant="outlined"
              ...
              <div className={classes.inputContainer}>
                <Typography variant="body2">To Ledger Account</Typography>
                <FormControl variant="filled" className={classes.textField}>
                  <Select
                    value={userType}
                    variant="outlined"
