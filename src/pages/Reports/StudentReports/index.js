          ...
          <Card elevation={3} className={classes.card}>
            ...
            <CardContent>
              <div className={classes.row}>
                <div className={classes.inputContainer}>
                  <Typography variant="body2">
                    Reports for <span className={classes.required}>*</span>
                  </Typography>
                ...
                <div className={classes.inputContainer}>
                  <Typography variant="body2">
                    School/Batch <span className={classes.required}>*</span>
                  </Typography>
                  <FormControl variant="filled" className={classes.textField}>
                    <Select
                      value={userType}
              ...
              <div className={classes.row}>
                <div className={classes.inputContainer}>
                  <div className={classes.row}>
                    <Typography variant="body2">School/Batch</Typography>
                    <Checkbox />
                  </div>
                </div>
                <div className={classes.inputContainer}>
                ...
                <div className={classes.inputContainer}>
                  <div className={classes.row}>
                    <Typography variant="body2">Guardian Details</Typography>
                    <Checkbox />
                  </div>
                </div>
                <div className={classes.inputContainer}>
                  <div className={classes.row}>
                    <Typography variant="body2">Patient's Details</Typography>
                    <Checkbox />
                  </div>
                </div>
              </div>
