        ...
        <Grid item xs={12} md={6}>
          <Card elevation={3} className={classes.card}>
            ...
            <CardContent>
              ...
              <div className={classes.inputContainer}>
                <Typography variant="body2">
                  Event Type <span className={classes.required}>*</span>
                </Typography>
              ...
              <div className={classes.inputContainer}>
                <Typography variant="body2">Organizer/Incharge Name</Typography>
                <TextField
                  variant="outlined"
                  InputProps={{
                    className: classes.textFieldInput,
              ...
              <div className={classes.inputContainer}>
                <Typography variant="body2">
                  Event For <span className={classes.required}>*</span>
                </Typography>
                <FormControl variant="filled" className={classes.textField}>
                  <Select
                    value={userType}
