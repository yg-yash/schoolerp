    ...
    <Wrapper padding={false}>
      <AppBar position="static" color="primary">
        <Toolbar className={classes.toolBar}>
          ...
          <ArrowRight />
          <Typography>Placed Details</Typography>
          <ArrowRight />
          <Typography>Placed Students List</Typography>
        </Toolbar>
      </AppBar>
      <div className={classes.root}>
        <AppBar position="static">
          ...
          >
            <Tab label="Placed Students List" {...a11yProps(0)} />
            <Tab label="Placed Details" {...a11yProps(1)} />
          </Tabs>
        </AppBar>
