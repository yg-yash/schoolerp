          ...
          <CardContent className={classes.row}>
            <div className={classes.inputContainer}>
              <Typography variant="body2">
                Assessment Name <span className={classes.required}>*</span>
              </Typography>
            ...
            <div className={classes.inputContainer}>
              ...
              <FormControl variant="filled" className={classes.textField}>
                <Select
                  ...
                  className={classes.select}
                >
                  <MenuItem value="india">First Term</MenuItem>
                  <MenuItem value="australia">Second Term</MenuItem>
                  <MenuItem value="usa">Third Term</MenuItem>
                </Select>
              </FormControl>
            </div>
            <div className={classes.inputContainer}>
              ...
              <FormControl variant="filled" className={classes.textField}>
                <Select
                  ...
                  className={classes.select}
                >
                  <MenuItem value="india">FORM 1</MenuItem>
                  <MenuItem value="australia">FORM 2</MenuItem>
                  <MenuItem value="usa">FORM 3</MenuItem>
                </Select>
              </FormControl>
            </div>
            <div className={classes.inputContainer}>
