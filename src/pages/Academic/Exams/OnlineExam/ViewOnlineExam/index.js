...
function createData(name, calories, fat, endate, status) {
  return { name, calories, fat, endate, status };
}

const rows = [
  createData(1, 'exam1', '2016-07-10', '2016-07-23', 'Published'),
  createData(2, 'exam2', '2016-07-10', '2016-07-23', 'Published'),
];
    ...
    <Wrapper padding={false}>
      <AppBar position="static" color="primary">
        <Toolbar className={classes.toolBar}>
          ...
          <ArrowRight />
          <Typography>Online Exams</Typography>
          <ArrowRight />
          <Typography>View Online Exams</Typography>
        </Toolbar>
      </AppBar>
